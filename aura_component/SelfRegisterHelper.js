({
    ...
    handleSelfRegister: function (component, event, helpler) {
        ...
        var wish = component.find("wish").get("v.value");
        ...
        action.setParams({firstname:firstname,lastname:lastname,email:email,
                          password:password, confirmPassword:confirmPassword, accountId:accountId, regConfirmUrl:regConfirmUrl, extraFields:extraFields, startUrl:startUrl, includePassword:includePassword, wish:wish});
